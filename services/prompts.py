def build_daily_prompt(today_str: str, market_overview_text, metals_data):
    return {
        ...
        Post 5 — The Forward Look (max 250 characters):
...
def build_monthly_prompt(today_str: str, market_overview_text):
    return {
        ...
        Post 2 — Sector Leaders (max 250 characters):
        ...
        Post 4 — Macro / Commodity Drivers (max 250 characters):
...
def build_morning_prompt(today_str: str):
    return {
        ...
        Post 5 — The Calendar Risk (max 250 characters):
